...
//         $this->load->model('admin/districts_model');
	...
	public function districts()
	{
		...
		{
			/* Breadcrumbs */
			$this->breadcrumbs->unshift(2, lang('menu_users_districts'), 'admin/users/districts');
			$this->data['breadcrumb'] = $this->breadcrumbs->show();
			
			$this->data['sub_title'] = lang('menu_users_districts');
			
			$group = $this->core_model->getUsersGroupId('district');
			
			$this->data['users'] = $this->core_model->getUsersByGroupId($group->id);
