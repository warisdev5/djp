...
class MY_Controller extends CI_Controller
{
	public function __construct()
	{
        ...
        $this->data['admin_n_super']		= array('admin', 'super');
        $this->data['district_n_members']	= array('district', 'members');
...
class District_Controller extends MY_Controller
{
	public function __construct()
	{
		parent::__construct();
		...
		{
			if ( ! $this->ion_auth->in_group($this->data['district_n_members']) )
			{
