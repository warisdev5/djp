			...
			<div class="box-header with-border">
				...
				<?php // echo anchor('district/users/create', '<span class="btn-label"><i class="fa fa-plus"></i></span> '. lang('users_create_user'), array('class' => 'btn btn-primary btn-labeled btn-flat hidden-print pull-right')); ?>
                    ...
                    <?php if ( !empty(validation_errors()) )  : ?>
					                ...
					                <?php endif; ?>
			<div class="box-body">
                            <form action="<?php echo base_url('district/cases/save') ?>" method="post">
                            <table id="dataTable" class="table table-striped table-bordered table-hover">
                	
                                    <thead>
                                        <tr>
                                            <th><?php echo lang("cases_select_date"); ?>:</th>
                                            <th> <input id="date-of-report" name="heading[date_of_report]" type="text" class="form-control datepicker" placeholder="<?php echo lang("cases_select_date"); ?>">
                                            </th>
                                        </tr>
                                        <tr>
                                            <th>SELECT HEADING</th>
                                            <th> <select id="heading" name="heading[heading_id]" class="form-control heading" >
