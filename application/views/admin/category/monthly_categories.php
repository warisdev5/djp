	...
	<div class="col-md-10">
		<div class="box">
			<div class="box-header with-border">
            	...
            	<?php echo anchor('admin/category/monthly_category_add', '<span class="btn-label"><i class="fa fa-plus"></i></span> '. lang('menu_monthly_cat_add'), array('class' => 'btn btn-primary btn-labeled btn-flat hidden-print pull-right')); ?>
			</div>
			<div class="box-body">
