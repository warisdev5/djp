...
<div class="row">
	<div class="col-md-6">
		<div class="box">
			...
			<?php echo form_open(base_url('admin/category/njp_category_save'), array( "class" => "form-horizontal", "data-toggle" => "validator")); ?>
			...
			<div class="box-footer">
				<div class="col-sm-8 col-sm-offset-4">
					<div class="btn-group">
                    	...
                    	<?php echo anchor('admin/category/njp_categories', lang('actions_cancel'), array('class' => 'btn btn-default btn-flat')); ?>
                    </div>
				</div>
			</div>
