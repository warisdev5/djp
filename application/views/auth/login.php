...
?>
            ...
            <div class="login-box-body">
            	<div class="login-logo">
	            	<a href="#">
	            		<img alt="DJP Logo" src="<?php echo base_url('upload/djp_logo.png')?>" width="120">
	            		<br><span style="font-size: 24px;font-weight:400;">District Judiciary Punjab</span></a>
	            </div>
                <h3 class=""><?php echo lang('auth_sign_session'); ?></h3>
                <?php echo $message;?>
