...
class Ion_auth
{
	 ...
	 * @author Mathew
	 **/
	public function register($identity, $password, $username, $email, $additional_data = array(), $group_ids = array()) //need to test email activation
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');

		$email_activation = $this->config->item('email_activation', 'ion_auth');

		$id = $this->ion_auth_model->register($identity, $password, $username, $email, $additional_data, $group_ids);
